...
public class OneToOne extends JFrame implements ActionListener {
	String imgPath	= "D:\\java_study\\workspace_java\\TCP_PROJECT\\tcp_project\\img";
	...
	JButton jbtn_emoticon = new JButton(new ImageIcon(imgPath+"버튼.png"));
	JButton jbtn_out = new JButton("ㅂㅇ");
	...
	public void initDisplay() {
		...
		jp_first_east.setLayout(new GridLayout(1,3));
		jp_first_east.add(jbtn_emoticon);
		jp_first_east.add(jbtn_send);
		jp_first_east.add(jbtn_out);
